...
const Steps = () => {
  ...
  <div className="mx-4 lg:mx-44 py-20 xl:py-40"> 
        ...
        <div className="flex items-start flex-wrap gap-4 mt-6 xl:mt-24 justify-center">
            ...
            <div   className="flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded   hover:scale-105 transition-all duration-500"> 
                    ...
                    <div>
                        ...
                        <p className="text-sm text-neutral-500 mt-1">This is demo text!dolor sit amet <br /> consectetur.</p>
                    </div>
            </div>
            ...
            <div   className="flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded   hover:scale-105 transition-all duration-500"> 
                    ...
                    <div>
                        <p className="text-xl font-medium">Dowload image</p>
                        <p className="text-sm text-neutral-500 mt-1">This is demo text!dolor sit amet <br /> consectetur.</p>
                    </div>
            </div>
