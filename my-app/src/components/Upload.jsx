  ...
  <div className="pb-16">
    {/* Title */}
          ...
          <div className="text-center mb-24"> 
                              ...
                              <label htmlFor="upload2" className="inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pionter bg-gradient-to-r from-violet-600 to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700">
